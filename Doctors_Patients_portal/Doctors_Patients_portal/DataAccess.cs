...
namespace Doctors_Patients_portal
{
    class DataAccess
    {
        ...
        private static string strConnString = @"Data Source=RIAZ\SQLEXPRESS;Initial Catalog=doctor_paitent;Integrated Security=True";
        ...
        {
            SqlConnection conn = new SqlConnection(@"Data Source=RIAZ\SQLEXPRESS;Initial Catalog=doctor_paitent;Integrated Security=True");
            conn.Open();
